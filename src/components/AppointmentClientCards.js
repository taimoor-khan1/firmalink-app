...
import { COLORS, height, IMAGES, SCREENS, SIZES, width } from '../constants';
import Icon, { IconType } from './Icons';
import LinearGradient from 'react-native-linear-gradient';
import CustomButton from './CustomButton';
import { useNavigation } from '@react-navigation/native';

export default function AppointmentClientCards( props ) {
    ...
    const RenderCard = () => {
        return (
            <TouchableOpacity
                onPress={() => {
                    navigation.navigate( SCREENS.AppointmentDetails )
                }}
                ...
                <View style={{ flexDirection: "row", alignItems: "center", marginTop: SIZES.fifteen }}>
                    ...
                    <View style={{ flexDirection: "row", alignItems: "center", marginLeft: SIZES.twenty }}>
                        <Icon
                            name={"clock"}
                            ...
                            size={SIZES.twenty}
                        />
                        <Text style={{ color: COLORS.gray, fontSize: SIZES.ten + 2, marginLeft: SIZES.five }}>12:00 PM</Text>
                    </View>
                    <View style={{ flexDirection: "row", alignItems: "center", marginLeft: SIZES.ten }}>
                        <Icon
                            name={"calendar"}
                            ...
                            size={SIZES.twenty}
                        />
                        <Text style={{ color: COLORS.gray, fontSize: SIZES.ten + 2, marginLeft: SIZES.five }}>April-24-2024</Text>
                    </View>
                </View>
                <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: SIZES.twenty, }}>
                    <TouchableOpacity style={{ paddingHorizontal: SIZES.ten, paddingVertical: SIZES.ten, width: "50%", alignItems: "center" }}>
                        <Text style={{ color: COLORS.red }}>
                            Cancel
                        </Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.downloadBtn}>
                        ...
                        <Text style={{ color: "#1877F2", textAlign: "center", fontWeight: "600", }}>
